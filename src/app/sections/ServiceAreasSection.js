  ...
  <div className=" p-6 md:p-8 lg:p-12 2xl:p-20 bg-gradient-3">
    <div className="text-center max-w-3xl mx-auto mb-16">
      ...
      <h2 className="text-3xl lg:text-4xl font-space font-bold mb-6">
        ...
        <span className="text-primary-light ml-2">Calgary & Surrounding </span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300">
          Areas
        </span>
      </h2>
      <p className="text-xl text-white">
        YYC Precast proudly provides fast delivery and professional installation
        throughout Calgary and nearby communities. Our local manufacturing
        ensures quick turnaround times, reliable service, and products that meet
        the unique needs of our region keeping your project on schedule and
        hassle-free.
      </p>
    </div>
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 items-center">
      <Link href={"/projects/calgary"}>
      ...
      <Link href={"/projects/chesteremere"}>
        <div className="relative rounded-xl group overflow-hidden">
          <Image
